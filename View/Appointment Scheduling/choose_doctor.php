  ...
  <body>
    ...
    <main>
      <section id="left-pane">
        ...
        <p id="doctor" class="left-pane-text active-text">
          &#x2022; Select Doctor
        </p>
      </section>
          ...
          <a href="select_schedule.php">
            <li class="main-doctor-container">
              ...
              <div class="doctor-info-container">
                ...
                <p class="doctor-schedule">Appointment: 8:00 PM</p>
                <p class="doctor-degree">
                  MBBS (SBMC), BCS (Health), FCPS (Surgery), F-MAS, Fellowship
                  in GI Endoscopy (Delhi)
                </p>
              </div>
            </li>
          </a>
    ...
    <script src="../../Controller/Appointment Scheduling/choose_doctor_validation.js"></script>
  </body>
</html>
