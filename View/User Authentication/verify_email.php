  ...
  require_once("../../Controller/User Authentication/send_code.php");
    ...
    if(isset($_POST['button-main'])) {
      if($_POST['otp'] == $_SESSION['otp']){
        header("Location: detailed_signup.php");
      }
    }
?>
    ...
    <main id="signup-main">
      ...
      <form id="user-auth" method="post" action="" enctype="" novalidate>
        ...
        <input
          ...
          id="button-main"
          value="Verify" />
        <form id="resend-code-form"  method="post" action="" enctype="multipart/form-data">
          <div id="label-container">
            <label id="resend-label">Didn't get the code?</label>
            <input type="submit" id="resend-code" name="resend-code" value="Wait 60s" disabled>
          </div>
        </form>
      </form>
    </main>
