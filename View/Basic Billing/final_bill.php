...
<html lang="en">
  ...
  <body>
    ...
    <main id="invoice-main">
      ...
      <div id="calculate-final-bill">
        <div class="bill-info-container">
          <label class="head">Subtotal</label>
          <label>5,900tk</label>
        </div>
        <div class="bill-info-container">
          <label class="head">Discount</label>
          <label>900tk</label>
        </div>
        <div class="bill-info-container">
          <label class="head">Insurance</label>
          <label>2,000tk</label>
        </div>
        <div class="bill-info-container">
          <label class="head total">Total</label>
          <label class="total">3,000tk</label>
        </div>

        <div id="final-cta">
          <p id="ending-text">THANK YOU FOR YOUR VISIT</p>
          <a href="payment_method.php" class="link-button">Pay Bill</a>
        </div>
      </div>
    </main>
