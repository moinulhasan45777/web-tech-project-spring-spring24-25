...
<html lang="en">
  ...
  <body>
    ...
    <main id="payment-method-main">
      <h1 id="heading">Select Payment Method</h1>
      <form
        id="select-payment-method"
        method="post"
        action="../../Controller/Basic Billing/process_payment_method.php"
      ...
      >
        <div class="input-container">
          ...
          <div class="radio-container">
            <input type="radio" name="payment-method" id="installment" value="installment"/>
            <label for="installment">Installment</label>
          </div>
        </div>
        <div class="input-container remove" id="installment-div">
          <label
            for="installment-duration"
        ...
        <input type="submit" name="button-main" id="button-main" value="Done" />
      </form>
    </main>
    ...
    <script src="../../Controller/Basic Billing/payment_method_validation.js"></script>
  </body>
</html>
